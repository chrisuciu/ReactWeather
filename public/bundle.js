	...
	var WeatherForm = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'form',
	                { name: 'cityForm', onSubmit: this.onFormSubmit },
	                React.createElement('input', { type: 'text', ref: 'location', placeholder: 'Enter city name here' }),
	                React.createElement(
	                    'button',
	                    null,
	                    'Get Weather'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=45187837af74aada38a26471e7174ad2&units=metric';

	// 45187837af74aada38a26471e7174ad2
